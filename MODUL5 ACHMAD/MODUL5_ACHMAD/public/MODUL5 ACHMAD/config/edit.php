<?php 
            ...
            if(isset($_POST['edit_car'])) {
                ...
                // query for update
                $query_syntax = "UPDATE showroom_rayhan_table SET nama_mobil='$nama_mobil', pemilik_mobil='$nama_pemilik', merk_mobil='$merk', tanggal_beli='$tanggal_beli', deskripsi='$deskripsi', status_pembayaran='$status_mobil'";
                $edit_query = mysqli_query($db, $query_syntax);

                // redirect to edit page
                header("Location:/MODUL5 ACHMAD/pages/Edit-Rayhan.php");
            }
        ?>