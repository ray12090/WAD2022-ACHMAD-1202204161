            ...
            <form action="../config/insert.php" method="POST" class="container row" id="form-group" enctype="multipart/form-data">
                ...
                <div class="mb-1">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="lunas" name="status" data-sb-validations="required" />
                        <label class="form-check-label" for="lunas">Lunas</label>
                    </div>

                    <!-- Belum Lunas -->
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="belumLunas" name="status" data-sb-validations="required" />
